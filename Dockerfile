...
COPY theme-v3/theme.b64.part* /tmp/theme-v3/
RUN cat /tmp/theme-v3/theme.b64.part* | base64 -d > /tmp/zosha-luxe-v3.tar.gz \
 && rm -rf /usr/src/wordpress/wp-content/themes/zosha-luxe \
 && mkdir -p /usr/src/wordpress/wp-content/themes/zosha-luxe \
 && tar -xzf /tmp/zosha-luxe-v3.tar.gz -C /usr/src/wordpress/wp-content/themes/zosha-luxe --strip-components=1 \
 && rm -rf /tmp/theme-v3 /tmp/zosha-luxe-v3.tar.gz
...
COPY railway-entrypoint-v3.sh /usr/local/bin/zosha-railway-entrypoint
