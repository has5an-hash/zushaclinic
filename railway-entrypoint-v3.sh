...
import_public_asset stock_facial 'https://images.pexels.com/photos/7789655/pexels-photo-7789655.jpeg?auto=compress&dpr=1&h=1200&w=1600' zosha-facial.jpg 'درمان تخصصی پوست در کلینیک زیبایی'
import_public_asset stock_laser 'https://images.pexels.com/photos/4586744/pexels-photo-4586744.jpeg?auto=compress&dpr=1&h=1100&w=1400' zosha-laser.jpg 'لیزر و جوانسازی پوست'
import_public_asset stock_spa 'https://images.pexels.com/photos/3985332/pexels-photo-3985332.jpeg?auto=compress&dpr=1&h=1100&w=1400' zosha-skincare.jpg 'فیشال و مراقبت تخصصی پوست'
...
echo "ZOSHA_BOOTSTRAP: design=3.0.0"
...
(
 ...
 HERO_COUNT="$(printf '%s' "$HOME_HTML" | grep -o 'hero-v3' | wc -l | tr -d ' ')"
 UPLOAD_COUNT="$(printf '%s' "$HOME_HTML" | grep -o '/wp-content/uploads/' | wc -l | tr -d ' ')"
 echo "ZOSHA_QA: hero-v3=${HERO_COUNT}"
 echo "ZOSHA_QA: local-images=${UPLOAD_COUNT}"
) &
